                        ...
                        @if ($role === 4)
                            <td style="width: 10%;">
                                <div class="btn-group-vertical">
                                    @if (empty($zonasi_plp_1->JointoPenilaian->JointoRkapAspek))
                                        <a href="{{ route('set.nilai', ['id' => $zonasi_plp_1->JointoPenilaian->id_penilaian]) }}"
                                            class="btn btn-success btn-sm">Set
                                            Nilai</a>
                                    @else
                                        <a href="{{ route('edit.nilai', ['id' => $zonasi_plp_1->JointoPenilaian->id_penilaian]) }}"
