                            ...
                            <div class="col-md-8">
                                ...
                                <p>:
                                    @if ($get_mhs->tgl_pembayaran != null)
                                        {{$get_mhs->tgl_pembayaran}}
                                        <button class="text-danger text-sm text-center" data-toggle="modal"
                                            data-target="#set-pembayaran" 
                                            id="btn-pmyrn"
                                            data-pembayaran="{{$get_mhs}}"
                                            ...
                                            style="background-color: Transparent; border: none;">&nbsp;&nbsp;
                                            <i class="fas fa-image"></i> File Bukti Pembayaran</button>
                                    @else
                                        {{'-'}}
