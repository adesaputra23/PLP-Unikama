            ...
            <div class="container">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="col-md-4 col-lg-3 mb-5">
                                <a href="{{route('pendaftaran-plp')}}">
                                        <div class="portfolio-item mx-auto" style="max-width: 18rem;">
                                                <div class="portfolio-item-caption d-flex align-items-center justify-content-center h-100 w-100">
                                                <div class="portfolio-item-caption-content text-center text-white"><i class="fas fa-plus fa-3x"></i></div>
                                                </div>
                                                <img class="img-fluid" src="assets/img/portfolio/reigistrasi.png" alt="..." />
                                                <h4 class="text-center mt-2">Pendaftaran PLP</h4>
                                        </div>
                                </a>
                        </div>
                         ...
                         <div class="col-md-4 col-lg-3 mb-5">
                                <a href="{{route('upload-bukti-pembayaran')}}">
                                        <div class="portfolio-item mx-auto" style="max-width: 18rem;">
                                                ...
                                                <img class="img-fluid" src="assets/img/portfolio/upload-file.png" alt="..." />
                                                <h4 class="text-center mt-2">Upload Bukti Pembayaran PLP</h4>
                                        </div>
                                </a>
                        </div>
                        ...
                        <div class="col-md-4 col-lg-3 mb-5">
                                <a href="{{route('zonasi')}}">
                                        <div class="portfolio-item mx-auto" style="max-width: 18rem;">
                                                ...
                                                <h4 class="text-center mt-2">Pemilihan Penempatan Sekolah</h4>
                                        </div>
                                </a>
                        </div>
                        ...
                        <div class="col-md-4 col-lg-3 mb-5">
                                <a href="{{url('pengumuman')}}">
                                        <div class="portfolio-item mx-auto" style="max-width: 18rem;">
                                                ...
                                                <h4 class="text-center mt-2">Pengumuman Penempatan Sekolah</h4>
                                        </div>
                                </a>
                        </div>
                        ...
                        <div class="col-md-4 col-lg-3 mb-5">
                                <a href="{{route('sertifikat')}}">
                                        <div class="portfolio-item mx-auto" style="max-width: 18rem;">
                                                ...
                                                <img class="img-fluid" src="assets/img/portfolio/sertifikat.png" alt="..." />
                                                <h4 class="text-center mt-2">Download Sertifikat PLP</h4>
                                        </div>
                                </a>
                        </div>
                    </div>
