                            ...
                            <tbody>
                                        ...
                                        <td>
                                            <div class="form-n1">
                                                ...
                                                <input type="number" max="{{ $indikator_dpl_n1->jumlah_nilai }}"
                                                    ...
                                                    name="indikator_dpl_n1[]" id="indikator_dpl_n1" required>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        ...
                                        <input type="text" class="form-control form-control-sm"
                                            name="jml_nilai_indikator_dpl_n1" id="jml_nilai_indikator_dpl_n1" readonly required>
                                    </th>
                                </tr>
                            </tbody>
                        </table>
                                        ...
                                        <td>
                                            <div class="form-n2">
                                                ...
                                                <input type="number" max="{{ $indikator_dpl_n2->jumlah_nilai }}"
                                                    ...
                                                    name="indikator_dpl_n2[]" id="indikator_dpl_n2" required>
                                                <span><small class="text-danger">Node*:nilai
                                ...
                                @foreach ($list_indikator_dpl_n3 as $item_n3 => $indikator_dpl_n3)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="text" class="form-control form-control-sm"
                                                name="indikator_dpl_n3[]" id="indikator_dpl_n3" required>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
