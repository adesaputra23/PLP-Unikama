            ...
            <form action="{{ route('proses.simpan.guru.pamong') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="nik" name="nik" placeholder="NIK Guru Pamong"
                                required oninvalid="this.setCustomValidity('NIK Guru Pamong Tidak Boleh Kosong')"
