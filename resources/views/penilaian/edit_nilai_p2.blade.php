                        ...
                        <tbody>
                            <tr>
                                <th colspan="2">
                                    RPP (N3)
                                    <button class="btn btn-info btn-sm float-right" type="button" data-toggle="modal"
                                        data-target="#modal-kriteria-n3" style="padding: 0px 2px 0px 2px">Keriteria (N3)</button>
                                </th>
                                <td class="text-center">Nilai</td>
                            </tr>
                            @php
                        ...
                        <tbody>
                            <tr>
                                <th colspan="2">
                                    ...
                                    <button class="btn btn-info btn-sm float-right" type="button" data-toggle="modal"
                                        data-target="#modal-kriteria-n4" style="padding: 0px 2px 0px 2px">Keriteria (N4)</button>
                                </th>
                                <td class="text-center">Nilai</td>
                            </tr>
                            @php
